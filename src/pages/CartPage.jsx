...
const styles = {
  ...
  qBtn: { width: '30px', height: '30px', borderRadius: '50%', border: '1px solid #ddd', backgroundColor: 'white', cursor: 'pointer', fontSize: '1.1rem', display: 'flex', alignItems: 'center', justifyContent: 'center' },
  ...
  orderButton: { width: '100%', backgroundColor: '#ff6b35', color: 'white', border: 'none', borderRadius: '12px', padding: '16px', fontSize: '1.1rem', cursor: 'pointer', fontWeight: 'bold', marginTop: '10px' },
